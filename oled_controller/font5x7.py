# 5x7 Font for OLED displays
# Converted from JavaScript font data

class Font5x7:
    """5x7 monospace bitmap font for OLED displays"""
    ...
    # Font bitmap data - each character is 5 bytes representing 5x7 pixels
    font_data = [
        ...
        0x00, 0x00, 0x07, 0x05, 0x07   # ° (degree symbol)
    ]
    ...
    def __init__(self):
        # Create character-to-index mapping for fast lookup
        self.char_map = {}
        for i, char in enumerate(self.lookup):
    ...
    def get_char_data(self, char):
        ...
        if char in self.char_map:
            ...
            start = index * 5
            return self.font_data[start:start + 5]
        else:
            # Return space character for unknown chars
            return self.font_data[0:5]
    
    def text_width(self, text):
        """Calculate width of text in pixels"""
        return len(text) * (self.width + 1)  # +1 for spacing between characters
    
    def char_exists(self, char):
        """Check if character exists in font"""
        return char in self.char_map